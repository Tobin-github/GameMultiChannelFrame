...
public class VivoPayCallbackAction extends UActionSupport{
    ...
    private static Logger log = Logger.getLogger(VivoPayCallbackAction.class.getName());
    ...
    public void payCallback(){
        try{
            ...
            log.debug("--------->payCallback ,respCode:"+respCode+", tradeStatus:"+tradeStatus);

            Integer realMoney = Integer.valueOf(orderAmount);

            if (!(realMoney+"").equals(order.getMoney()+"")) {
