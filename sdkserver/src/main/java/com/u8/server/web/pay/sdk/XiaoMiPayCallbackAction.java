...
public class XiaoMiPayCallbackAction extends UActionSupport{
    ...
    private static Logger log = Logger.getLogger(XiaoMiPayCallbackAction.class.getName());
    ...
    public void payCallback(){
        ...
        try{
            ...
            log.info("The product Name is " + this.productName);
            ...
            if (realMoney != order.getMoney()) {
                log.error("order error ,money:"+order.getMoney()+",channelMoney:"+realMoney);
                this.renderState(1525, "order money error");
                return;
            }
