 ...
 */
@Controller
@Namespace("/pay/singlemeizu")
public class SingleMeiZuPayCallbackAction extends UActionSupport{

    private static Logger log = Logger.getLogger(SingleMeiZuPayCallbackAction.class.getName());
    ...
    private String product_per_price;			//String  Y  产品 单价
    private String product_unit  	;			//String  Y
    ...
    public void payCallback(){
        try{
            ...
            while (pNames.hasMoreElements()) {
                ...
                log.debug("SingleMeiZuPayCallbackAction params.name:" + name + ", value:" + value);
            }
            ...
            if(channel == null){
                log.error("-------->payCallback ,channel is null,order:" + order.toJSON());
                this.renderState(false);
                return;
            }
            ...
            log.info("--------->payCallback's trade_status:" + trade_status);
