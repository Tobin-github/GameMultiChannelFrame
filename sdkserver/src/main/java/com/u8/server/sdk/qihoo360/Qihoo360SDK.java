...
public class Qihoo360SDK implements ISDKScript {
    ...
    private static Logger log = Logger.getLogger(Qihoo360SDK.class.getName());
    //private static final String notifyUrl = "http://120.25.243.133:8080/pay/qihoo360/payCallback";
    //public static final String notifyUrl = "http://u8s.wgb.cn:9080/pay/wxpay/payCallback";
    ...
    public void onGetOrderID(UUser user, UOrder order, ISDKOrderListener callback) {
        ...
        //Integer moneyAmount = order.getMoney();
        ...
        try {
            ...
            json.put("notifyUrl", order.getGame().getPayCallback());
